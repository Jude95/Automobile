...
import com.jude.automobile.presenter.BrandAddPresenter;
 ...
 */
@RequiresPresenter(BrandAddPresenter.class)
public class BrandAddActivity extends BeamDataActivity<BrandAddPresenter, Brand> {
